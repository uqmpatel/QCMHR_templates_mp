...
output: 
  html_document:
    css: R-esources/style_QCMHR.css
    toc: true
    toc_float: true
    number_sections: true
    code_folding: "hide"
    includes:
      before_body: R-esources/header_QCMHR.html
      after_body: R-esources/footer.html
...
<br>
    ...
    <div align="right">![_Community_](R-esources/Community 2.png){width="100%"}</div>
...
<center>
# ![_Relationships II_](R-esources/relationships 2.png){width="50%"}
</center>
...
# ![Be sweet with cherries on top](R-esources/cupcake.png){width="30%"}
...
# <div align="center">![They're all blessings](R-esources/gratitude.png){width="50%"}</div>
...
# <div align="right">![love like a rainbow coloured heart shaped cumulo-nimbus](R-esources/Heartcloud.png){width="30%"}</div>
...
<details>
  <summary>Penguins moving to the right</summary>
    <center>
     <br>
![](R-esources/walking-penguins-emperor-penguins.gif)
   </center>
</details>
...
#   <source src="R-esources/movie.mp4" type="video/mp4">
# </video>
...
#  <img src="R-esources/in bloom.png">
# </div>
